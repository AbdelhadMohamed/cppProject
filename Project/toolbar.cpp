...
//========================================================================
iconAddPowerBrickup1::iconAddPowerBrickup1(point r_uprleft, int r_width, int r_height, game* r_pGame) :
toolbarIcon(r_uprleft, r_width, r_height, r_pGame)
{}
void iconAddPowerBrickup1::onClick()
{

	pGame->printMessage("Click on empty cells to add Power UP/DOWN Bricks  ==> Right-Click to stop <==");
	int x, y;
	clicktype t = pGame->getMouseClick(x, y);
	while (t == LEFT_CLICK)
	{
		...
		clicked.y = y;
		grid* pGrid = pGame->getGrid();
		pGrid->addBrick(BRK_POWERup1, clicked);
		pGrid->draw();
		t = pGame->getMouseClick(x, y);
	}
	pGame->printMessage("");
...
//========================================================================
iconAddPowerBrickup2::iconAddPowerBrickup2(point r_uprleft, int r_width, int r_height, game* r_pGame) :
	toolbarIcon(r_uprleft, r_width, r_height, r_pGame)
{}
void iconAddPowerBrickup2::onClick()
{
	...
	while (t == LEFT_CLICK)
	{
		...
		clicked.y = y;
		grid* pGrid = pGame->getGrid();
		pGrid->addBrick(BRK_POWERup2, clicked);
		pGrid->draw();
		t = pGame->getMouseClick(x, y);
	}
	pGame->printMessage("");
...
//========================================================================
iconAddPowerBrickdown1::iconAddPowerBrickdown1(point r_uprleft, int r_width, int r_height, game* r_pGame) :
	toolbarIcon(r_uprleft, r_width, r_height, r_pGame)
{}
void iconAddPowerBrickdown1::onClick()
{
	...
	while (t == LEFT_CLICK)
	{
		...
		clicked.y = y;
		grid* pGrid = pGame->getGrid();
		pGrid->addBrick(BRK_POWERdown1, clicked);
		pGrid->draw();
		t = pGame->getMouseClick(x, y);
	}
	pGame->printMessage("");
...
void icondelBrick::onClick()
{
	...
	while (t == LEFT_CLICK)
	{
		...
		clicked.y = y;
		grid* pGrid = pGame->getGrid();
		pGrid->addBrick(BRK_DEL, clicked);
		pGrid->draw();
		t = pGame->getMouseClick(x, y);
	}
	pGame->printMessage("");
...
{	
	...
	iconsImages[ICON_ADD_POWERup1] = "images\\power\\fireBall.jpg";
	iconsImages[ICON_ADD_POWERup2] = "images\\power\\WindGlide.jpg";
	iconsImages[ICON_ADD_POWERdown1] = "images\\power\\ReverseDirection.jpg";
	iconsImages[ICON_DELET] = "images\\ToolbarIcons\\IconDelete.jpg";
	...
	iconsList[ICON_ADD_POWERup1] = new iconAddPowerBrickup1(p, config.iconWidth, height, pGame);
	p.x += config.iconWidth;

	iconsList[ICON_ADD_POWERup2] = new iconAddPowerBrickup2(p, config.iconWidth, height, pGame);
	p.x += config.iconWidth;

	iconsList[ICON_ADD_POWERdown1] = new iconAddPowerBrickdown1(p, config.iconWidth, height, pGame);
	p.x += config.iconWidth;

	iconsList[ICON_DELET] = new icondelBrick(p, config.iconWidth, height, pGame);
	p.x += config.iconWidth;
