...
//================================================================
class iconAddPowerBrickup1 :public toolbarIcon
{
public:
	iconAddPowerBrickup1(point r_uprleft, int r_width, int r_height, game* r_pGame);
	virtual void onClick();
};
//================================================================
class iconAddPowerBrickup2 :public toolbarIcon
{
public:
	iconAddPowerBrickup2(point r_uprleft, int r_width, int r_height, game* r_pGame);
	virtual void onClick();
};
//================================================================
class iconAddPowerBrickdown1 :public toolbarIcon
{
public:
	iconAddPowerBrickdown1(point r_uprleft, int r_width, int r_height, game* r_pGame);
	virtual void onClick();
};
//================================================================
